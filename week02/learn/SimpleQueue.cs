public class SimpleQueue {
    public static void Run() {
        ...
        // Defect(s) Found: trying to dequeue at the wrong integer
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: Inserting item into wrong index/
    ...
    private void Enqueue(int value) {
        _queue.Add(value);     // inerting at the same place you dequeue, should insert at the back
    }
    ...
    private int Dequeue() {
        ...
        var value = _queue[0];  //wrong index
        _queue.RemoveAt(0);
        return value;
    }
}